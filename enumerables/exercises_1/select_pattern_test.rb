...
class SelectPatternTest < Minitest::Test
  ...
  def test_pick_words_with_more_than_three_letters
    words = ["pill", "bad", "finger", "cat", "blue", "dog", "table", "red"]
    selected = []
    words.select {|word| selected << word if word.length > 3}
  ...
  def test_pick_words_ending_in_e
    ...
    selected = []
    words.select {|word| selected << word if word.end_with?("e")}
  ...
  def test_pick_words_ending_in_ing
    ...
    selected = []
    words.select {|word| selected << word if word.end_with?("ing")}
  ...
  def test_pick_words_containing_e
    ...
    selected = []
    words.select {|word| selected << word if word.include?("e")}
  ...
  def test_pick_dinosaurs
    ...
    dinosaurs = []
    animals.select {|animal| dinosaurs << animal if animal.end_with?("aurus")}
  ...
  def test_pick_floats
    ...
    floats = []
    numbers.select {|num| floats << num if num.class == Float}
  ...
  def test_pick_arrays
    ...
    arrays = []
    elements.select {|element| arrays << element if element.class == Array}
  ...
  def test_pick_hashes
    ...
    hashes = []
    elements.select {|element| hashes << element if element.class == Hash}
