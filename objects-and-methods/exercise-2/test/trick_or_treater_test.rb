...
class TrickOrTreaterTest < Minitest::Test
  ...
  def test_eating_candies_increases_the_sugar_level
    ...
    trick_or_treater.bag.candies << Candy.new("Candy Canes", 88)
    trick_or_treater.bag.candies << Candy.new("Dum Dum Pops", 83)
    trick_or_treater.bag.candies << Candy.new("Lollipops", 71)
    trick_or_treater.eat
    trick_or_treater.eat
    trick_or_treater.eat
